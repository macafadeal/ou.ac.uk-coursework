#This template has been created to accompany the Week-19 Commenting work on the VCE
...
#  This script can be executed using 'python3 ./skeletons/week_19_commenting-skeleton.py' in the console
